 ...
 * @param {boolean} [options.diff] - Suppress diffs from failures?
 ...
 * @param {boolean} [options.inlineDiffs] - Use inline diffs?
...
Mocha.prototype.hideDiff = function(hideDiff) {
  this.options.diff = !(hideDiff !== undefined && hideDiff);
  return this;
};
